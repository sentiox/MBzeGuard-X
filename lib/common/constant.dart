...
const appName = "MBzeGuard";
const appHelperService = "MBzeGuardHelperService";
const coreName = "clashx.meta";
const browserUa =
    "Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/120.0.0.0 Safari/537.36";
const packageName = "com.mbzeguard.app";
final unixSocketPath = "/tmp/MBzeGuardSocket_${Random().nextInt(10000)}.sock";
...
const repository = "mbzeguard/MBzeGuard";
...
const mainIsolate = "MBzeGuardMainIsolate";

const serviceIsolate = "MBzeGuardServiceIsolate";
