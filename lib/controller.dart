...
import 'package:mbzeguard/common/archive.dart';
import 'package:mbzeguard/services/subscription_notification_service.dart';
...
import 'package:mbzeguard/widgets/dialog.dart';
...
class AppController {
  ...
  void _applyThemeColorFromHex(String hexHeader) {
    try {
      ...
      commonPrint
          .log('Applying theme from mbzeguard-hex: #${hexString.toUpperCase()}'
